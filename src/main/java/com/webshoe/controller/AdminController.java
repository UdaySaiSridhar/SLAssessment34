...
public class AdminController {
	...
	public ResponseEntity<User> getSignedUpUser(@PathVariable("userName") String userName) {
	...
	public ResponseEntity<List<PurchaseReport>> getPurchaseReportBasedOnCategory(@PathVariable("category") String category) {
	...
	public ResponseEntity<List<PurchaseReport>> getPurchaseReportBasedOnDate(@PathVariable("date") String date) throws ParseException {
